    ...
    return BlocBuilder<ThemeCubit, ThemeState>(
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          endDrawer: EndDrawer(),
          body: BlocProvider(
            create:widget.isOwner? (context) => AppartmentCubit()..getMyApartment():(context)=>AppartmentCubit()..getAllApartment(),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        state is AppartmentLoading
                            ...
                            : _buildApartmentsGrid(isDark,widget.isOwner? cubit.myappartments:cubit.appartments),
                        const SizedBox(height: 24),
                      ],
                    ),
                  ),
