            ...
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => ApartmentDetailsPage(apartment: apt),
                  ),
                ).then((_) => setState(() {}));
              },
              child: Container(
                      ...
                      child: Stack(
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              images.isNotEmpty ? images[0] : 'assets/images/placeholder.jpg',
                              fit: BoxFit.cover,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(apt['city'], style: TextStyle(color: Colors.grey[600])),
                          const SizedBox(height: 4),
                          Text(
                            "${apt['price']} \$ / شهر",
                            style: TextStyle(
