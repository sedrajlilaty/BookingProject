class Urls {
  static const String domain = "http://192.168.1.104:8000";
  static const String storageUrl = "$domain/storage/";
  static const String fcmToken = "$domain/fcm-token";
  static const String baseUrl = "$domain/api";
  static const String addAppartments = "$baseUrl/apartments";
  static const String getAppartments = "$baseUrl/apartments";
  static const String getMyAppartments = "$baseUrl/apartment_user";
